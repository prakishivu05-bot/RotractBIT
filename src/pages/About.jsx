      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "50px", alignItems: "center" }}>
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} style={{ flex: "1 1 500px" }}>
          ...
          <p style={{ color: "var(--text-secondary)", lineHeight: "1.8", fontSize: "1.05rem", textAlign: "justify", marginBottom: "30px" }}>
            The club comes under the Rotaract District Organization 3191 and its sponsor club is Rotary Bangalore South. The Rotaract Club of BIT conducts innumerable events making it one of the most active Rotaract clubs. Some of these events are-Blood Donation Camp, Paperdrive, Rush Hours, Secret Santa, Akshara, Trek and Uptown Junk. All of these events create a positive impact on our community and also helps the individuals to enhance their professional as well as personal skills.
          </p>
